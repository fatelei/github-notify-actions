...
exports.Wecom = exports.Slack = exports.Lark = void 0;
const lark_1 = __importDefault(__nccwpck_require__(4185));
exports.Lark = lark_1.default;
const slack_1 = __importDefault(__nccwpck_require__(5369));
exports.Slack = slack_1.default;
const wecom_1 = __importDefault(__nccwpck_require__(440));
exports.Wecom = wecom_1.default;
...
class Lark {
    ...
    generateMessage(messageType, title, content) {
        switch (messageType) {
            case 'text':
                return {
                    title,
    ...
    sendMessage(messageType, title, content) {
        return __awaiter(this, void 0, void 0, function* () {
            const body = this.generateMessage(messageType, title, content);
            if (!body) {
                return Promise.reject(new Error('Unsupported message type'));
            }
            return axios_1.default.post(this.webhook, body);
        });
    }
}
...
class Slack {
    ...
    generateMessage(messageType, content) {
        switch (messageType) {
            case 'text':
                return {
                    text: content
    ...
    sendMessage(messageType, title, content) {
        return __awaiter(this, void 0, void 0, function* () {
            const body = this.generateMessage(messageType, content);
            if (!body) {
                return Promise.reject(new Error('Unsupported message type'));
            }
            return axios_1.default.post(this.webhook, body);
...
class Wecom {
    ...
    generateMessage(messageType, message) {
        switch (messageType) {
            case 'text':
                return {
                    msgType: 'text',
...
Wecom.supportMessageType = ['text'];
exports.default = Wecom;
...
const integration_1 = __nccwpck_require__(6611);
const getIntegration = (integration, webhook) => {
    switch (integration) {
        case 'lark':
            core.debug(`init ${integration} instance`);
            return new integration_1.Lark(webhook);
        case 'slack':
            core.debug(`init ${integration} instance`);
            return new integration_1.Slack(webhook);
        case 'wecom':
            core.debug(`init ${integration} instance`);
            return new integration_1.Wecom(webhook);
        default:
            core.debug(`init ${integration} instance`);
            return null;
    }
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const cli = getIntegration(integration, webhook);
            if (!cli) {
            ...
            yield cli.sendMessage(messageType, title, content);
